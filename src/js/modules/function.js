...
export const hiddenAdv = () => {
    const closeButton = document.querySelector('.header__adv-img > a');
    const advBlock = document.querySelector('.header__adv');
...
export const playVideo = () => {
    const playButton = document.querySelector('.video__wrapper .play > a');
    const videoWrapper = document.querySelector('.video__wrapper .play');
    const iframe = document.querySelector('.video__wrapper iframe');
    const src = 'https://www.youtube.com/embed/_3Awyv0Gf7E'
...
export const presentation = () => {
    const slider = new Swiper('.swiper-presentation', {
...
export const photosSlider = () => {
    const slider = new Swiper(`.swiper-photos`, {
        modules: [Navigation],
        // loop: true,
        spaceBetween: 20,
        slidesPerView: 2,
        ...
        // watchSlidesProgress: true,
        navigation: {
            nextEl: `.photos__arrows-right`,
            prevEl: `.photos__arrows-left`,
        },
        // pagination: {
        //     el: `.production__pagination_${index}`,
        //     clickable: true
